    ...
    <div class="table">
        ...
        <el-dialog title="添加歌曲" :visible.sync="centerDialogVisible" width="400px" center>
            <el-form :model="registerForm" ref="registerForm" label-width="80px" action="" id="tf">
               <el-form-item prop="singerName" label="歌手-歌名" size="mini">
                    <el-input v-model="registerForm.singerName" placeholder="歌手-歌名"></el-input>
                </el-form-item>  
                 <el-form-item prop="songName" label="歌曲名字" size="mini">
                    <el-input v-model="registerForm.songName" placeholder="歌手-歌名"></el-input>
                </el-form-item>           
            </el-form>
            <span slot="footer">
...
import {listSongDetail,listSongAdd,delListSong,songOfSongId,songOfSongName} from '../api/index';
...
export default {
    ...
    methods:{
        ...
        //根据歌曲id查询歌曲对象，放到tempData和tableData里边
        getSong(id){
            songOfSongId(id)
             .then(res => {
