          ...
          <el-dialog title="修改歌手" :visible.sync=" editVisible" width="400px" center>
            <el-form :model="form" ref="form" label-width="80px">
                ...
                <el-form-item prop="location" label="地区" size="mini">
                    ...
                    <el-cascader size="large" :options="options" v-model="selectedOptions"  @change="edithandleChange">
    </el-cascader>
                </el-form-item>
                <el-form-item prop="introduction" label="简介" size="mini">
...
select_word: function(){
    ...
    if(this.select_word == ''){
        ...
        // 如果搜索框有内容，先把tableData制空，也就是歌手信息显示框指控，然后遍历tempData赋值给item，如果搜索框里的内容包含在item里，那么tableData.push(item)
        this.tableData = [];
