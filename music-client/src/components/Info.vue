  ...
  <div class="title">
        ...
        <el-form :model="registerForm" ref="registerForm" label-width="70px" class="demo-ruleForm" :rules="rules">
            ...
            <el-form-item prop="phoneNum" label="手机">
                <el-input v-model="registerForm.phoneNum" placeholder="手机" clearable></el-input>
            </el-form-item>
            ...
            <el-form-item prop="introduction" label="签名">
                <el-input v-model="registerForm.introduction" placeholder="签名" clearable></el-input>
            </el-form-item>
         ...
         <div class="btn">
                <div @click="goback(-1)" type="success" round>取消</div>
                <div type="primary" @click="saveMsg" round>保存</div>
            </div>
        </div>
...
import { SignUp,getUserOfId,updateUserMsg } from "../api/index";
export default {
    name: 'info',
    mixins: [mixin],
    data() {
